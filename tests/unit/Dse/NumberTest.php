...
class NumberTest extends \PHPUnit_Framework_TestCase {
    ...
    public function highOverflowValues()
    {
        ...
        foreach(self::LIMITS as $class => $limits) {
            ...
            foreach (array(2 => "0b", 8 => "0", 10 => "", 16 => "0x") as $base => $prefix) {
                ...
                if ($class == "Dse\\Bigint" && PHP_INT_MAX == (2 ** 31) - 1) {
                    continue;
                }

                $val = ($class == "Dse\\Bigint") ?
        ...
        $provider[] = array("Dse\Tinyint", "2147483648");
        $provider[] = array("Dse\Smallint", "2147483648");
    ...
    public function lowOverflowValues()
    {
        ...
        $provider[] = array("Dse\Tinyint", "-2147483649");
        $provider[] = array("Dse\Smallint", "-2147483649");
     ...
     *
     * @expectedException Dse\Exception\RangeException
    ...
    /**
     * @dataProvider numberClasses
     * @expectedException Dse\Exception\DivideByZeroException
