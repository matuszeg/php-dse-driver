...
class MapTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @expectedExceptionMessage  keyType must be a string or an instance of Dse\Type, an instance of stdClass given
     */
    public function testInvalidKeyType()
    {
        new Map(new \stdClass(), \Dse::TYPE_VARCHAR);
    }
    ...
    {
        new Map('custom type', \Dse::TYPE_VARCHAR);
    }

    /**
     * @expectedException        InvalidArgumentException
     * @expectedExceptionMessage keyType must be a valid Dse\Type,
    ...
    /**
     * @expectedException         InvalidArgumentException
     * @expectedExceptionMessage  valueType must be a string or an instance of Dse\Type, an instance of stdClass given
     */
    public function testInvalidValueType()
    {
        new Map(\Dse::TYPE_VARCHAR, new \stdClass());
    }
    ...
    {
        new Map(\Dse::TYPE_VARCHAR, 'custom type');
    }

    /**
     * @expectedException        InvalidArgumentException
     * @expectedExceptionMessage valueType must be a valid Dse\Type,
     *                           an instance of Dse\Type\UnsupportedType given
     */
     ...
     * @expectedExceptionMessage  Unsupported type 'custom type'
     */
    public function testSupportsOnlyDseTypesForKeys()
    {
        new Map('custom type', \Dse::TYPE_VARINT);
    }
     ...
     */
    public function testSupportsOnlyDseTypesForValues()
    {
        new Map(\Dse::TYPE_VARINT, 'another custom type');
    }
    ...
    {
        $map = new Map(\Dse::TYPE_VARCHAR, \Dse::TYPE_VARCHAR);
        $map->set("test", null);
    }
    ...
    public function testSupportsForeachIteration()
    {
        ...
        $values = array('a', 'b', 'c',
                        'd', 'e', 'f',
                        'g', 'h');
        $map = new Map(\Dse::TYPE_VARINT, \Dse::TYPE_VARCHAR);
