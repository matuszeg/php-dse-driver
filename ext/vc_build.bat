...
SET PHP_DRIVER_DIRECTORY=php-driver
...
SET PHP_5_6_BRANCH_TAG_VERSION=php-5.6.27
SET PHP_7_0_BRANCH_TAG_VERSION=php-7.0.12
...
SET "ABSOLUTE_DEPENDENCIES_PHP_DRIVER_SOURCE_DIRECTORY=%ABSOLUTE_BATCH_DIRECTORY%\%PHP_DRIVER_DIRECTORY%"
...
IF !ENABLE_CLEAN_BUILD! EQU !TRUE! (
  ...
  CALL :CLEANDIRECTORY "!ABSOLUTE_DEPENDENCIES_PHP_DRIVER_SOURCE_DIRECTORY!" "Cleaning php-driver submodule directory"
...
REM Initialize and update the php-driver submodule
IF NOT EXIST "!ABSOLUTE_DEPENDENCIES_PHP_DRIVER_SOURCE_DIRECTORY!\ext\php_cassandra.h" (
  PUSHD "!ABSOLUTE_BATCH_DIRECTORY!\.." > NUL
  ECHO Update php-driver submodule > "!LOG_DRIVER_BUILD!"
  ECHO | SET /P="Update php-driver submodule ... "
  !GIT! submodule update --init --recursive !ABSOLUTE_DEPENDENCIES_PHP_DRIVER_SOURCE_DIRECTORY! >> "!LOG_DRIVER_BUILD!" 2>&1
  IF !ERRORLEVEL! EQU 0 (
    ECHO done.
    POPD
  ) ELSE (
...
REM @param log-filename Absolute path and filename for log output
:BUILDDRIVER [php-source-directory] [extension-source-directory] [install-directory] [enable-test-configuration] [enable-thread-safety] [build-type] [libiconv-library-directory] [libxml2-library-directory] [cpp-driver-library-directory] [kerberos-library-directory] [libuv-library-directory] [openssl-library-directory] [zlib-library-directory] [mpir-library-directory] [log-filename]
  REM Create php-driver variables from arguments
