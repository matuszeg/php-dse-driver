...
Feature: Duration
  ...
  Scenario: Use the duration type
    ...
    And the following example:
      ...
      $durations = array(
          array('two_days', new Dse\Duration(2, 0, 0)),
          array('twelve_hours', new Dse\Duration(0, 12, 0)),
          array('three_seconds', new Dse\Duration(0, 0, 3 * (1000 ** 3))),
          array('two_days_twelve_hours_and_three_seconds', new Dse\Duration(2, 12, 3 * (1000 ** 3)))
      );
